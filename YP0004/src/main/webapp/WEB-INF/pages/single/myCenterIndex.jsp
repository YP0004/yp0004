                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="sparkbar" data-color="#00a65a" data-height="20">2015-1-2</div></td>
                                    </tr>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR1848</a></td>
                                        <td>Java中级课程</td>
                                        <td><span class="label label-warning">待支付</span></td>
                                        <td><div class="sparkbar" data-color="#f39c12" data-height="20">2015-3-1</div></td>
                                    </tr>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR7429</a></td>
                                        <td>Hadoop入门课程（7天入门Hadoop课程）</td>
                                        <td><span class="label label-danger">待评价</span></td>
                                        <td><div class="sparkbar" data-color="#f56954" data-height="20">2015-4-1</div></td>
                                    </tr>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR7429</a></td>
                                        <td>大数据时代</td>
                                        <td><span class="label label-info">待支付</span></td>
                                        <td><div class="sparkbar" data-color="#00c0ef" data-height="20">2014-5-1</div></td>
                                    </tr>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR1848</a></td>
                                        <td>Oracle入门详解</td>
                                        <td><span class="label label-warning">待付款</span></td>
                                        <td><div class="sparkbar" data-color="#f39c12" data-height="20">2015-4-1</div></td>
                                    </tr>
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR7429</a></td>
                                        <td>数据库快速入门</td>
                                    ...
                                    <tr>
                                        <td><a href="pages/examples/invoice.html">OR9842</a></td>
                                        <td>计算机导论</td>
                                        <td><span class="label label-success">待评价</span></td>
                                        <td><div class="sparkbar" data-color="#00a65a" data-height="20">2015-4-1</div></td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">Java入门课程 <span class="label label-warning pull-right">已更新3节</span></a>
                        <span class="product-description">
                          机器编码：xxxxxxxxx
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">计算机导论 <span class="label label-info pull-right">更新完毕</span></a>
                        <span class="product-description">
                         机器编码:$$$$$$$$$$$$$$$$$$$4
                        </span>
                                    </div>
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">Java中级课程 <span class="label label-danger pull-right">新更新2节</span></a>
                        <span class="product-description">
                          机器编码：#########################3
                        </span>
                                    </div>
                                ...
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="javascript::;" class="product-title">Hadoop入门知识 <span class="label label-success pull-right">更新3节</span></a>
                        <span class="product-description">
                          机器编码：&&&&&&&&&&&&&&&&&&77777
                        </span>
                                    </div>
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user1-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">阿拉蕾</a>
                                    <span class="users-list-date">今天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user8-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">奥特曼</a>
                                    <span class="users-list-date">今天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user7-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">蜡笔小新</a>
                                    <span class="users-list-date">今天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user6-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">芭比娃娃</a>
                                    <span class="users-list-date">今天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user2-160x160.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">美人鱼</a>
                                    <span class="users-list-date">昨天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user5-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">喜洋洋</a>
                                    <span class="users-list-date">昨天</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user4-128x128.jpg" alt="User Image"/>
                                    <a class="users-list-name" href="#">美羊羊</a>
                                    <span class="users-list-date">1.1</span>
                                </li>
                                <li>
                                    <img src="${pageContext.request.contextPath}/single/dist/img/user3-128x128.jpg" alt="User Image"/>
